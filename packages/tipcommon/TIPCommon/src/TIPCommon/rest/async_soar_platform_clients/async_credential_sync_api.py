...
class AsyncCredentialSyncApi(BaseAsyncSoarApi):
    ...
    async def get_installed_integrations_of_environment(
        ...
        Returns:
            SingleJson: The response JSON containing integration instances.
    ...
    async def get_connector_cards(
        ...
        Returns:
            SingleJson: The response JSON containing connector instances.
    ...
    async def get_installed_jobs(
        ...
        Returns:
            SingleJson: The response JSON containing job instances.
    ...
    async def set_configuration_property(
        ...
        Returns:
            SingleJson: The response JSON with updated property details.
        ...
        """
        endpoint: str = (
            f"/legacySdk:legacyUpdateConfigurationProperty"
        )
        params: SingleJson = {
    ...
    async def set_connector_parameter(
        ...
        Returns:
            SingleJson: The response JSON with updated parameter details.
        ...
        """
        endpoint: str = (
            f"/legacySdk:legacyUpdateConnectorParameter"
        )
        params: SingleJson = {
