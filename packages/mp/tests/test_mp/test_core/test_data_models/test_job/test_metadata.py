...
from .strategies import (
    ST_VALID_BUILT_JOB_METADATA_DICT,
    ST_VALID_NON_BUILT_JOB_METADATA_DICT,
)
...
class TestValidations:
    ...
    def test_valid_non_built(self, valid_non_built: NonBuiltJobMetadata) -> None:
        JobMetadata.from_non_built(FILE_NAME, valid_non_built)
