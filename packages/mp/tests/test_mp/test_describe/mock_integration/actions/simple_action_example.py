...
class SimpleActionExample(SampleAction):
    ...
    def _validate_currencies_params(self, validator: ParameterValidator) -> None:
        ...
        self.logger.info(f"Action is going to get data for currencies: {currencies!r}")
    ...
    def _validate_time_params(self, validator: ParameterValidator) -> None:
        ...
        self.logger.info(f"Using start_time {self.params.start_date!r}")
        self.logger.info(f"Using end_time {self.params.end_date!r}")
