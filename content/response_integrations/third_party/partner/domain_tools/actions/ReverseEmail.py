"""
Action script for Domain Tools - Reverse Email.
...
def main():
    ...
    #  Get scope entities.
    scope_entities = [
        entity for entity in siemplify.target_entities if entity.entity_type == UNIQUEUSER
    ]

    for entity in scope_entities:
        # Get response
        res = domaintools_manager.get_domains_by_email(entity.identifier)
