...
def main() -> None:
    ...
    try:
        ...
        siemplify.LOGGER.error(
            "Failed to process typosquatting detections after {} alert(s); cursor NOT advanced — next run will retry from sequpdate {} (SOAR dedupes via source_grouping_identifier).".format(
