...
from rubrik_security_cloud.actions import get_dspm_violation_details
from rubrik_security_cloud.tests.common import CONFIG_PATH, MOCK_DSPM_VIOLATION_DETAILS
...
class TestGetDSPMViolationDetails:
    ...
    def test_get_dspm_violation_details_success(
        ...
        success_output_msg_prefix = "Successfully retrieved DSPM violation details"

        get_dspm_violation_details.main()
    ...
    @set_metadata(
        ...
        parameters={"Violation ID": "not-a-valid-uuid"},
    )
    def test_get_dspm_violation_details_invalid_uuid(
        self,
        script_session: RubrikSession,
        action_output: MockActionOutput,
        rubrik: RubrikSecurityCloud,
