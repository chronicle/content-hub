...
from rubrik_security_cloud.actions import list_events
from rubrik_security_cloud.tests.common import CONFIG_PATH, MOCK_LIST_EVENTS
...
class TestListEvents:
    ...
    def test_list_events_success(
        ...
        rubrik.list_events_response = MOCK_LIST_EVENTS
