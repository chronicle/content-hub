...
from constants import (INTEGRATION_NAME, GET_ASNS_FOR_DOMAIN_SCRIPT_NAME )
...
def main():
    ...
    try:
        ...
        result_value = False
        status = EXECUTION_STATE_FAILED
        output_message = f"Failed to retrieve ASNs of domain :{domain} for {INTEGRATION_NAME} server! Error: {error}"
