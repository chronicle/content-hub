...
from constants import (INTEGRATION_NAME, RUN_THREAT_CHECK_SCRIPT_NAME )
...
def main():
    ...
    try:
        ...
        result = sp_manager.run_threat_check(data=data,type=type_arg, user_identifier=user_identifier,query=query)
