...
from constants import (INTEGRATION_NAME, ADD_FEED_SCRIPT_NAME )
...
def main():
    ...
    try:
        ...
        result = sp_manager.add_feed(name=name, type=type_arg, category=category, vendor=vendor, feed_description=feed_description, tags= tags)
