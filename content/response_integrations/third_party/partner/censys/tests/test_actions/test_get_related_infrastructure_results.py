...
class TestGetRelatedInfrastructureResults:
                        ...
                        "field_value_pairs": [
                            {
                                ...
                                "value": "2cc63dd4bb612501f18f6b25441bf9adc3dcd35edd0f1beb9f6a30ae3262f942",
                            }
                        ],
                    },
                    {
                        "count": 36216,
                        "field_value_pairs": [
                            {"field": "services.http.response.headers.key", "value": "Content-Type"},
                            {"field": "services.http.response.headers.value", "value": "text/plain"},
                        ],
                    },
                ],
            }
    ...
    def test_get_results_empty_job_id(self, mock_siemplify_class, mock_api_manager_class):
    ...
    def test_get_results_multi_field_pivot(self, mock_siemplify_class, mock_api_manager_class):
