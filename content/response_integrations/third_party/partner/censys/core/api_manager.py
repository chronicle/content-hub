...
class APIManager:
    ...
    #     self,
    #     query: str,
    #     max_pages: int = MAX_PAGINATION_CALLS,
    ...
    #     Returns:
    #         Dict containing all paginated results with combined hits
    ...
    #     current_payload_size = 0
    #     total_available = 0
    #     truncation_reason = None  # Track why pagination stopped
    ...
    #         batch_size = len(json_str.encode("utf-8"))
    #         potential_total_size = current_payload_size + batch_size
    ...
    #                 f"total would be: {potential_total_size / (1024 * 1024):.2f} MB). "
    #                 f"Ignoring this batch and stopping pagination."
    #             )
    #             break
    ...
    #         # Add the batch and update size
    #         # If max_records specified, only add what we need
    #         if max_records:
