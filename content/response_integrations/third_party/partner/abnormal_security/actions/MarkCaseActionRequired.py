"""Mark Case Action Required action for Abnormal Security Google SecOps SOAR Integration."""
...
@output_handler
def main() -> None:
    """Main execution logic for the Mark Case Action Required action."""
    ...
    try:
        ...
        output_message = f"Case {case_id} marked as action required."
        result_value = True
        ...
        output_message = (
            f'Error executing action "{MARK_CASE_ACTION_REQUIRED_SCRIPT_NAME}". Reason: {e}'
        )
