"""Unremediate Threat action for Abnormal Security Google SecOps SOAR Integration."""
...
@output_handler
def main() -> None:
    """Main execution logic for the Unremediate Threat action."""
    ...
    try:
        ...
        output_message = f"Unremediate request submitted for threat {threat_id}."
        result_value = True
        ...
        output_message = (
            f'Error executing action "{UNREMEDIATE_THREAT_SCRIPT_NAME}". Reason: {e}'
        )
