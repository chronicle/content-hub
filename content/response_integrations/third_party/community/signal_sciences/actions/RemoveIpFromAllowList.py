...
class RemoveIpFromAllowListAction(SignalSciencesAction):
    def __init__(self):
        super().__init__("SignalSciences - Remove IP from Allow List")
    ...
    def _perform_action(self, _=None) -> None:
        ...
        for item in current_list:
            # Signal Sciences usually returns 'ip' or 'source'
        ...
        self.result_value = len(success_ips) > 0 or len(not_found_ips) == len(ips)  # Success if all found or already gone
