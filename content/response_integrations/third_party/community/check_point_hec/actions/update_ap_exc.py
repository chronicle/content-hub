...
SUCCESS_MESSAGE: str = "Successfully updated Anti-Phishing exception!"
ERROR_MESSAGE: str = "Failed updating Anti-Phishing exception!"
...
class UpdateAPException(BaseAction):
    ...
    def _extract_action_parameters(self) -> None:
        ...
        self.params.exception_id = self.soar_action.extract_action_param(
            param_name="Exception ID",
            print_value=True,
            is_mandatory=True,
            default_value=None,
        )
    ...
    def _perform_action(self, _=None) -> None:
        ...
        self.api_client.update_ap_exception(
