"""Get CTP List action – retrieves a single Click Time Protection exception list by ID."""
...
class GetCTPList(BaseAction):
    """Retrieve a single CTP exception list identified by its *List ID*."""
    ...
    def _extract_action_parameters(self) -> None:
        """Extract the mandatory *List ID* parameter."""
    ...
    def _perform_action(self, _=None) -> None:
        """Call the CTP API to fetch the list and store it in ``json_results``."""
