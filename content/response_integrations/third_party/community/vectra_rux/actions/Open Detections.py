...
def main():
    ...
    siemplify.script_name = OPEN_DETECTIONS_SCRIPT_NAME
    ...
    try:
        ...
        detection_status = vectra_manager.open_detections(detection_ids)

        output_message = "The provided detection IDs have been successfully re-opened"
