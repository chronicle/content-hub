...
from ..core.constants import (
    ...
    RESULT_VALUE_FALSE,
    RESULT_VALUE_TRUE,
    SET_DETECTION_STATUS_SCRIPT_NAME,
)
...
def main():
    ...
    siemplify.script_name = SET_DETECTION_STATUS_SCRIPT_NAME
    ...
    investigation_status = siemplify.extract_action_param(
        param_name="Investigation Status",
        input_type=str,
        is_mandatory=True,
    ).lower()
    ...
    try:
        ...
        detection_status = vectra_manager.set_detection_status(detection_ids, investigation_status)

        output_message = (
            f"The investigation Status for provided Detection ID(s) have been "
            f"updated as {investigation_status}"
        )
