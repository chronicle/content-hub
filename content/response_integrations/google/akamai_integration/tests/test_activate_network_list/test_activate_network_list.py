...
from akamai_integration.actions.activate_network_list import ActivateNetworkList
from akamai_integration.tests.common import (
    CONFIG_PATH,
    NETWORK_ACTIVATION_LIST,
    NETWORK_LIST,
)
...
SUCCESS_OUTPUT_MESSAGE: str = "Successfully activated the network list in Akamai."
FAILED_OUTPUT_MESSAGE: str = (
    "Error executing action \"Akamai - Activate Network List\"\nReason: 'Test!' network"
    " list wasn't found in Akamai."
)
...
def test_activate_network_list_success(
    ...
    akamai.add_network_item_list(NETWORK_ACTIVATION_LIST)
...
def test_activate_network_list_failed(
    akamai: Akamai,
    script_session: AkamaiSession,
    action_output: MockActionOutput,
) -> None:
