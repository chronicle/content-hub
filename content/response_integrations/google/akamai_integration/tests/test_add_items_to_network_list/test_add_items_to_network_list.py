...
from akamai_integration.actions.add_items_to_network_list import (
    AddItemsToNetworkLists,
)
...
SUCCESS_OUTPUT_MESSAGE: str = (
    "Successfully updated network list 'Test' in Akamai."
)
FAILED_OUTPUT_MESSAGE: str = (
    'Error executing action "Akamai - Add Items To Network List"\nReason: "Test!" '
