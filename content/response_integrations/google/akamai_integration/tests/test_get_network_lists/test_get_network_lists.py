...
SUCCESS_OUTPUT_MESSAGE: str = "Successfully returned network lists from Akamai."
...
@set_metadata(
    parameters={
        ...
        "Max Network Lists To Return": 10,
        "Max Network List Items To Return": 10,
    },
...
def test_get_network_lists_failed(
    akamai: Akamai,
    script_session: AkamaiSession,
    action_output: MockActionOutput,
) -> None:
