...
# ============================================================================#
# title           :aws_guard_duty_manager.py
...
from .aws_guard_duty_parser import aws_guard_duty_parser
from . import consts
from . import utils


class aws_guard_duty_manager:
    """
    ...
    def __init__(
        ...
        self.parser = aws_guard_duty_parser()
    ...
    def validate_response(response, error_msg="An error occurred"):
        ...
        if (
            ...
            not in aws_guard_duty_manager.VALID_STATUS_CODES
        ):
