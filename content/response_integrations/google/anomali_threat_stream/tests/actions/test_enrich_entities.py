...
from anomali_threat_stream.actions.enrich_entities import main
...
def test_enrich_entities_success(
    ...
    # Patch AnomaliManager in enrich_entities
    monkeypatch.setattr(
        "anomali_threat_stream.actions.enrich_entities.AnomaliManager",
