...
from .manager import SecretManagerClient


class SecretManagerAction(Action, ABC):
    """Base action class for Secret Manager actions."""
    ...
    def _init_api_clients(self) -> SecretManagerClient:
        """Extract config and initialize the API client.

        Returns:
            SecretManagerClient: The initialized client.
