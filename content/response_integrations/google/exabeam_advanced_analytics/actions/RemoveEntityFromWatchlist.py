...
def main():
    ...
    siemplify.script_name = (
        f"{INTEGRATION_NAME} - {REMOVE_ENTITY_FROM_WATCHLIST_SCRIPT_NAME}"
    )
    ...
    try:
        ...
        if suitable_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(
                    f"Successfully removed {num_added_entities} entities"
                )

                if num_added_entities != len(suitable_entities_identifiers):
                    siemplify.LOGGER.info(
                        f"Checking which entities failed be removed from watchlist"
                    )
                    ...
                    successful_entities_identifiers.extend(
                    ...
                    if successful_entities_identifiers:
                        ...
                        siemplify.LOGGER.info(
                            f"No entities were successfully removed from watchlist"
                        )
                    ...
                    failed_entities_identifiers.extend(
                        [
                            ...
                            if entity.identifier not in successful_entities_identifiers
                        ]
                    )
                else:
                    successful_entities_identifiers.extend(
