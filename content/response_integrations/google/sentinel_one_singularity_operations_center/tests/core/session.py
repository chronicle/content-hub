...
class SentinelOneSession(MockSession[MockRequest, MockResponse, SentinelOne]):
    ...
    def graphql_endpoint(self, request: MockRequest) -> MockResponse:  # noqa: PLR0911
        try:
            ...
            return MockResponse(content={"errors": [{"message": f"Invalid payload: {e}"}]}, status_code=400)
        ...
        if "GetUnifiedAlerts" in query:
            ...
            try:
                ...
                return MockResponse(content={"errors": [{"message": str(e)}]}, status_code=500)
        ...
        return MockResponse(content={"errors": [{"message": "Unknown query"}]}, status_code=200)
