...
from ..core.constants import INTEGRATION_NAME, UPDATE_RECORD_ACTION
from ..core.BMCHelixRemedyForceExceptions import RecordTypeNotFound, RecordNotCreated
import json
...
def main():
    ...
    fields_to_update = extract_action_param(
        siemplify, param_name="Fields To Update", print_value=True, is_mandatory=True
    )
    ...
    try:
        try:
            ...
            raise Exception(
                'Invalid JSON payload provided in the parameter "Fields To Update". Please check the structure.'
            )
