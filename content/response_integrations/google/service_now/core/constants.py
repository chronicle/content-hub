...
ADD_COMMENT_AND_WAIT_FOR_REPLY_SCRIPT_NAME = (
    f"{INTEGRATION_NAME} - Add Comment And Wait For Reply"
)
...
TICKET_ID = "TICKET_ID"
PARAM_UPDATED_TIME: str = "updated_time"
FIELD_SYS_UPDATED_ON: str = "sys_updated_on"
