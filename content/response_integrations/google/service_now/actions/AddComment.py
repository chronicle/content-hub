...
from ..core.constants import INTEGRATION_NAME, ADD_COMMENT_SCRIPT_NAME
...
def main():
    ...
    try:
        ...
        output_message = f'Successfully added comment "{comment}" to incident with number {incident_number}.'
        ...
        output_message = (
            f"General error performing action {ADD_COMMENT_SCRIPT_NAME}. Reason: {e}"
        )
        result_value = False
