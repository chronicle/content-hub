...
class AddParentIncident(Action):
    ...
    def _perform_action(self, _) -> None:
        try:
            parent_incident = self.api_client.check_incidents(
                [self.params.parent_incident_number]
            )
        ...
        if parent_incident:
            try:
                ...
                found_child_incident_numbers = [
                    incident.number for incident in child_incidents
                ]
