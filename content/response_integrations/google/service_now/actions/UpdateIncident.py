...
def main():
    ...
    assigned_to = extract_action_param(
        siemplify, param_name="Assigned User ID", print_value=True
    )
    description = extract_action_param(
        siemplify, param_name="Description", print_value=True
    )
    incident_state = extract_action_param(
        siemplify, param_name="Incident State", print_value=True
    )
    ...
    try:
        try:
            ...
            raise InvalidParameterException(
                "Invalid value was found in the 'Custom Fields' parameter. "
        ...
        if assigned_to:
            try:
                ...
                raise TypeError(
                    f"User '{assigned_to}' wasn't found in ServiceNow. "
