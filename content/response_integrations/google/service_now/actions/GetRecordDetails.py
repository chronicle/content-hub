...
from ..core.constants import INTEGRATION_NAME, GET_RECORD_DETAILS_SCRIPT_NAME
...
def main():
    ...
    fields = (
        [field.strip() for field in fields_str.split(",") if field.strip()]
        if fields_str
        else []
    )
    ...
    try:
        ...
        output_message = (
            f'Error executing action "{GET_RECORD_DETAILS_SCRIPT_NAME}". Reason: {err}'
        )
        result_value = False
