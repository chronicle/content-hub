...
from ..core.constants import INTEGRATION_NAME, CREATE_RECORD_SCRIPT_NAME
...
def main():
    ...
    json_data = extract_action_param(
        siemplify, param_name="Object Json Data", print_value=True
    )
    ...
    try:
        ...
        if obj.is_empty():
            ...
            output_message = f'Successfully created record with Sys ID {obj.sys_id} in table "{table_name}".'
        ...
        output_message = (
            f"General error performing action {CREATE_RECORD_SCRIPT_NAME}. Reason: {e}"
        )
        result_value = False
