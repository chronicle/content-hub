...
from ..core.constants import INTEGRATION_NAME, GET_INCIDENT_SCRIPT_NAME
...
def main():
    ...
    try:
        ...
        output_message = (
            f'Successfully retrieved incident with number "{incident_number}".'
        )
        ...
        output_message = (
            f"General error performing action {GET_INCIDENT_SCRIPT_NAME}. Reason: {e}"
        )
