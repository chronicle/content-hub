...
def main():
    ...
    try:
        ...
        if incident.is_empty():
            ...
            output_message = f"Successfully created incident with number {incident.number} based on the alert."
        ...
        output_message = f"General error performing action {CREATE_ALERT_INCIDENT_SCRIPT_NAME}. Reason: {e}"
        result_value = False
