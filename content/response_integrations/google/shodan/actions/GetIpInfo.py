...
def main():
    ...
    try:
        for entity in siemplify.target_entities:
            ...
            if entity.entity_type == EntityTypes.ADDRESS:
                try:
                    ...
                    if ip_info:
                        siemplify.LOGGER.info(f"Found information for entity {entity.identifier}")
                        json_results[entity.identifier] = ip_info

                        # Add csv table
                        siemplify.LOGGER.info(f"Adding CSV table for {entity.identifier}")
                    ...
                    # Entity not found
                    siemplify.LOGGER.error(f"Entity {entity.identifier} was not found in Shodan.")
        ...
        if successful_entities:
            output_message = (
                "The following IPs were submitted and analyzed in Shodan:\n   {}".format(
        ...
        siemplify.LOGGER.error(f"General error occurred while running action {SCRIPT_NAME}")
        siemplify.LOGGER.exception(e)
