...
from ..core.constants import INTEGRATION_NAME, CREATE_REQUEST_ACTION, CREATE_REQUEST_TYPE
...
def main():
    ...
    try:
        ...
        output_message = f"Error executing action {CREATE_REQUEST_ACTION}. Reason: {e}"
