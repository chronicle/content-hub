...
parser: ServiceDeskPlusV3Parser = ServiceDeskPlusV3Parser()
REQUEST: Request = parser.build_request_object(MOCK_DATA["GET_REQUESTS_RESPONSE_FULL"])
ADD_REQUEST_MOCK: Request = parser.build_request_object(
