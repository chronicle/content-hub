...
from ...actions import AddNoteToAlert
from ...core.constants import ADD_NOTE_TO_ALERT_SCRIPT_NAME
...
SUCCESS_OUTPUT_MESSAGE: str = (
    f"Successfully added a note to the alert with ID {ALERT['id']}."
)
FAILED_OUTPUT_MESSAGE: str = (
    f'Error executing action "{ADD_NOTE_TO_ALERT_SCRIPT_NAME}".\nReason: Alert with '
