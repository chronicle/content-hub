...
SCRIPT_NAME = "Mitre Att&ck - Get Mitigations"
...
def main():
    ...
    try:
        ...
        if intrusions:
            siemplify.result.add_data_table(
                ...
                data_table=construct_csv(
                    [intrusion.to_mitigations_data_table() for intrusion in intrusions]
                ),
            )
            siemplify.result.add_result_json(
                [intrusion.to_json() for intrusion in intrusions]
            )
            output_message = f"Found mitigations for {identifier} technique!"
            ...
            output_message = f"Didn't find any mitigations for {identifier} technique!"
        ...
        output_message = f'Error executing action "Get Mitigations". Reason:{e}'
