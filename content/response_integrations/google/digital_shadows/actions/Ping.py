...
def main():
    ...
    try:
        ...
        output_message = "Successfully connected to the DigitalShadows."
        ...
        result_value = "false"
        output_message = f"Failed to connect to the DigitalShadows. Reason: Error executing action 'Ping action'. Reason: {e}"
