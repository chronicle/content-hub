...
def test_opensearch_dsl_connector(
    ...
    script_session: OpenSearchSession,
    ...
    original_extract_params = connector.extract_params
    def custom_extract_params():
        original_extract_params()
        if hasattr(connector, "params") and hasattr(connector.params, "alerts_count_limit"):
            connector.params.alerts_count_limit = int(connector.params.alerts_count_limit)
    connector.extract_params = custom_extract_params
    connector.start()
