...
class JuniperVSRXManager:
    ...
    def remove_ip_from_address_set(self, ip_address, address_set_name, zone=None):
        ...
        if zone:
            ...
            self.config.load(
                DELETE_RECORD_FROM_SET_COMMAND.format(address_set_name, address_record_name),
                format=COMMAND_FORMAT,
            )
        return True
    ...
    def get_ip_record_name_by_ip(self, ip_address):
        ...
        if address_book:
            ...
            raise JuniperVSRXManagerError(f'Error, not found name for IP "{ip_address}"')
        raise JuniperVSRXManagerError(f'Error, not found addresses for IP "{ip_address}"')
