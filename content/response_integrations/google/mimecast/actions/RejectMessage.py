...
from mimecast.core.constants import INTEGRATION_NAME, REJECT_MESSAGE_ACTION
...
def main():
    ...
    notify_sender = extract_action_param(
        siemplify,
        param_name="Notify Sender",
        print_value=True,
        is_mandatory=False,
        input_type=bool,
        default_value=False,
    ...
    try:
        ...
        manager.reject_message(
            message_id=message_id, note=note, reason=reason, notify_sender=notify_sender
        )
