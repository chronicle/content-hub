...
from mimecast.core.constants import INTEGRATION_NAME, PERMIT_SENDER_ACTION
...
def main():
    ...
    sender = extract_action_param(
        siemplify, param_name="Sender", print_value=True, is_mandatory=True
    )
    recipient = extract_action_param(
        siemplify, param_name="Recipient", print_value=True, is_mandatory=True
    )
