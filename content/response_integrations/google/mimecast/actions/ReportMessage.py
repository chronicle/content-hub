...
def main():
    ...
    comment = extract_action_param(
        siemplify, param_name="Comment", print_value=True, is_mandatory=False
    )
    report_as = extract_action_param(
        siemplify,
        param_name="Report As",
        print_value=True,
        is_mandatory=False,
        default_value="Spam",
    )
    ...
    try:
        ...
        manager.report_message(
            message_id=message_id, comment=comment, report_as=report_as
        )
