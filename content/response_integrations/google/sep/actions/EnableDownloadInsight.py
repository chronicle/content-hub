...
def main():
        ...
        try:
            ...
            if computer_id:
                siemplify.LOGGER.info(
                    f"Enabling DownloadInsight on {entity.identifier}"
                )
            ...
            errors += f"Enabling Download Insight failed on {entity.identifier}:\n{e}\n"
    ...
    if enriched_entities:
        ...
        output_message += (
            "Enabling Download Insight on the following entities:\n"
            + "\n".join(entities_names)
        )
