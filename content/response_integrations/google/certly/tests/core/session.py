...
from .product import Certly


class CertlySession(MockSession[MockRequest, MockResponse, Certly]):
    def get_routed_functions(self) -> list[RouteFunction]:
        return []

    _DEFAULT_DICT_RESPONSE = {
        "ok": True,
        "result": "success",
        "data": {"id": "mock_id", "name": "mock"},
        "results": [{"id": "mock_id"}],
        "token": "mock_token_value",
        "access_token": "mock_token_value",
        "accessToken": "mock_token_value",
        "refreshToken": "mock_refresh_token",
        "session": "mock_session",
        "sid": "mock_session_id",
        "userId": "mock_user",
        "selectedAccountSettingsId": "mock_account",
        "expires_in": 3600,
        "token_type": "Bearer",
        "offering": "community",
        "success": True,
