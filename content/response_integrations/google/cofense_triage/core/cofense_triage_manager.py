...
from .cofense_triage_parser import cofense_triage_parser
from .cofense_triage_exceptions import CofenseTriageException, RecordNotFoundException
...
import datetime
from .utils_manager import filter_old_alerts
...
class cofense_triage_manager:
    def __init__(
        ...
        self.parser = cofense_triage_parser()
