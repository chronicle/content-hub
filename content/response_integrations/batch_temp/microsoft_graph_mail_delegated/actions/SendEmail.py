...
class SendEmail(Action[api_manager.ApiManager]):

    def __init__(self) -> None:
        super().__init__(constants.SEND_EMAIL_SCRIPT_NAME)
        self.output_message = ""
        self.error_output_message = (
            f'Error executing action "{constants.SEND_EMAIL_SCRIPT_NAME}".'
        )
    ...
    def _extract_action_parameters(self) -> None:
        ...
        self.params.mail_content_type = extract_action_param(
            self.soar_action,
            param_name="Mail Content Type",
            default_value=constants.DEFAULT_MAIL_CONTENT_TYPE,
            is_mandatory=False,
            print_value=True,
        )
    ...
    def _validate_params(self) -> None:
        ...
        validator.validate_ddl(
            param_name="Mail Content Type",
            value=self.params.mail_content_type,
            ddl_values=constants.MAIL_CONTENT_TYPE.keys(),
            case_sensitive=True,
        )
        invalid_paths = []
        invalid_paths = [
        ...
        if invalid_paths:
            ...
            error_message = (
                "The action failed to run because following attachments were not found:"
                f" {invalid_paths}"
            )
    ...
    def _perform_action(self, _) -> None:
        ...
        sent_email = _get_sent_draft_email(
    ...
    def _send_email(self) -> MicrosoftGraphEmail:
        return self.api_client.send_email(
            ...
            mail_content_type=self.params.mail_content_type,
